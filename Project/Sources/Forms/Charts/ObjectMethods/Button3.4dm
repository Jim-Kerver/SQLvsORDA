...
$dataORDA:=$ORDA.getSalesPerProduct()

//convert data into graph
$graph:=cs:C1710.Chart.Plotly.new()
$graph.setTitle("Total sales value per product ORDA")
$graph.setXAxisTitle("Product")
...
$dataSQL:=$SQL.getSalesPerProduct()

//convert data into graph (reuse existing $graph class instance)
$graph.setTitle("Total sales value per product SQL")
